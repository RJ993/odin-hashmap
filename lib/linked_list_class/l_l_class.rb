...
class LinkedList
  ...
  def head
    return self.head_node.node_value
  end

  def tail
    return self.tail_node.node_value
  end
  ...
  def pop
    pointer = @head_node
    until pointer.next_value == @tail_node
      pointer = pointer.next_value
    end
  ...
  def contains?(value)
    pointer = @head_node
    until pointer.node_value == value || pointer.next_value == nil
      pointer = pointer.next_value
    end
    if pointer.node_value == value
      return true
  ...
  def to_s
    ...
    pointer = @head_node
    until pointer == nil
      string_list = string_list + "( #{pointer.node_value} ) -> "
      pointer = pointer.next_value
    end
